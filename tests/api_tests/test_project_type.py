...
class TestProject(BaseApiTest):
    ...
    def test_user_creates_project(self, test_data):
        ...
        with allure.step("Check project was created successfully with correct data"):
            created_project_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_project_with_parent_project(self, test_data):
        """User should be able to create project with parent project"""
        with allure.step("Create user"):
            user_request = CheckedRequest(self.specifications.superUserSpec(), Endpoint.USERS.url)
            new_user = user_request.create(test_data.user.model_dump())
        with allure.step("Create a parent project by user"):
            parent_project_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
        ...
        with allure.step("Create a child project by user"):
            child_project_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
        ...
        with allure.step("Check child project was created successfully with correct data"):
            created_child_project_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_two_projects_with_same_id(self, test_data):
        ...
        with allure.step("Create project 2 by user with same id"):
            ...
            second_project_request = UncheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_two_projects_with_same_name(self, test_data):
        ...
        with allure.step("Create project 2 by user with same name"):
            ...
            second_project_request = UncheckedRequest(self.specifications.authSpec(test_data.user),
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_project_with_empty_name(self, test_data):
        """User cannot create project with empty name"""
        with allure.step("Create user"):
            user_request = CheckedRequest(self.specifications.superUserSpec(), Endpoint.USERS.url)
            new_user = user_request.create(test_data.user.model_dump())
        with allure.step("Create project by user with empty name"):
            project_request = UncheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_project_with_empty_id(self, test_data):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_creates_project_without_permission(self, test_data):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_admin_user_creates_project_in_another_user_project_area(self, test_data):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_user_copy_project(self, test_data):
        ...
        with allure.step("Copy project"):
            ...
            project_copy_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
        ...
        with allure.step("Check project was copied successfully with correct data"):
            project_copy_created_request = CheckedRequest(self.specifications.authSpec(test_data.user), Endpoint.PROJECTS.url)
